...
(defn home-page
  ...
  (page/html5
   ...
   [:p [:a {:href "http://192.168.0.132:8080/wiki/ru/"} "Вики"]
    " позволяет накапливать различную информацию и предоставляет доступ к ней всем. Не стоит надеяться на свою память сохраните все " [:a {:href "http://192.168.0.132:8080/wiki/ru/"} "здесь!"]]))
